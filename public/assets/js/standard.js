...
(function () {
  ...
  function attach(form) {
    ...
    // Pairing min/max per parameter (agar bisa auto-swap)
    const groups = {};
    inputs.forEach(function (el) {
      // normalization behavior (sama seperti inline script sebelumnya)
      ...
      el.addEventListener('blur', function () {
        ...
        // cek pair min/max, kalau kebalik -> swap diam-diam
  ...
  document.addEventListener('DOMContentLoaded', function () {
    // format & pair handling (berlaku untuk JSH dan ACE)
    document.querySelectorAll('form').forEach(attach);

    // auto dismiss alerts (persis seperti di inline script)
