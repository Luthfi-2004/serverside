        ...
        <form id="gsForm" class="modal-content" autocomplete="off">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="gsModalLabel">
                    ...
                    <!-- <span class="badge badge-info ml-2" id="gsShiftInfo">Shift: -</span> -->
                </h5>
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-2"><input type="number" step="any" name="bc9_moist"
                                                id="bc9_moist" class="form-control" placeholder="Moisture BC 9"></div>
                                        <div class="col-md-4 mb-2"><input type="number" step="any" name="bc10_moist"
                                                id="bc10_moist" class="form-control" placeholder="Moisture BC 10"></div>
                                        <div class="col-md-4 mb-2"><input type="number" step="any" name="bc11_moist"
                                                id="bc11_moist" class="form-control" placeholder="Moisture BC 11"></div>
                                    </div>
                                </div>
