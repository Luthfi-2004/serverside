<div class="modal fade" id="modal-user" tabindex="-1" role="dialog" aria-labelledby="modalUserLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="userForm" action="{{ route('admin.users.store') }}" method="POST" class="modal-content">
      @csrf
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="password">Password <small class="text-muted" id="pwdHint">(wajib saat tambah)</small></label>
