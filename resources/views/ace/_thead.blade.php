<thead class="table-dark">
  ...
  <tr class="std-row">
    @foreach($COL_MM as $k)
      @if(!in_array($k, $ROWSPAN4))
        <th class="text-center">{{ $range($k) }}</th>
      @endif
    @endforeach
    @foreach($COL_ADD as $k)
      @if(!in_array($k, $ROWSPAN4))
        <th class="std-spacer"></th>
      @endif
    @endforeach
    @foreach($COL_BC13 as $k)
      @if(!in_array($k, $ROWSPAN4))
  ...
  <tr class="std-row">
    @foreach($COL_MM as $k)
      @if(!in_array($k, $ROWSPAN4))
        <th class="text-center">{{ $unit($k) }}</th>
      @endif
    @endforeach
    @foreach($COL_ADD as $k)
      @if(!in_array($k, $ROWSPAN4))
  ...
  <tr class="std-row">
    @foreach($COL_MM as $k)
      @if(!in_array($k, $ROWSPAN4))
        <th class="text-center">{{ $freq($k) }}</th>
      @endif
    @endforeach
    @foreach($COL_ADD as $k)
      @if(!in_array($k, $ROWSPAN4))
