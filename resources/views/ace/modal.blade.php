        ...
        <form id="aceForm" class="modal-content" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs mb-3" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-add" role="tab"><i class="ri-pie-chart-2-line mr-1"></i> Additive Additional</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-bc13" role="tab"><i class="ri-alert-line mr-1"></i> Pengecekan BC13</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade" id="tab-add" role="tabpanel">
                        <div class="row">
                            ...
                            @foreach($addFields as [$name, $label])
                                ...
                                <div class="col-md-3 mb-3">
                                    <label class="mb-1">{{ $labelText }}</label>
                                    <input type="number" step="0.01" name="{{ $name }}" id="m_{{ $name }}" class="form-control" placeholder="Input Sample {{ $labelText }}">
                                </div>
                            @endforeach
                        </div>
                    </div>
