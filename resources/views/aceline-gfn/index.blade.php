        ...
        <div class="col-12">
          ...
          <div class="card mb-3">
            <div id="filterHeader"
              ...
              data-toggle="collapse" data-target="#filterCollapse" aria-expanded="{{ $isOpen ? 'true' : 'false' }}"
              ...
              <div class="card-body">
                <form id="filterForm" class="row align-items-end" method="GET" action="{{ route('acelinegfn.index') }}">
                    ...
                    <div class="form-group mb-2">
                      ...
                      <div class="input-group">
                        <input id="fDate" type="text" name="date" class="form-control gs-input"
                          value="{{ $filters['date'] ?? '' }}" autocomplete="off" placeholder="YYYY-MM-DD"
                  ...
                  <div class="col-xl-6 col-lg-4 mb-2">
                    ...
                    <select class="form-control select2" name="shift" data-placeholder="-- Select Shift --"
                      autocomplete="off">
                      <option value=""></option>
                  ...
                  <div class="col-xl-6 col-lg-12 mt-2">
                    <div class="d-flex flex-wrap">
                      ...
                      <a class="btn btn-outline-success btn-sm mb-2"
                        href="{{ route('acelinegfn.export', request()->only('date', 'shift')) }}">
                ...
                <div class="col-lg-6">
                  <div class="card h-100">
                    <div class="card-body d-flex flex-column">
                      ...
                      <div id="gfn-line" class="flot-charts flot-charts-height" style="height:300px; flex:1 1 auto;">
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content border-0">
        ...
        <div class="modal-footer">
          ...
          <form id="deleteForm" action="{{ route('acelinegfn.deleteToday') }}" method="POST" class="m-0 p-0">
            @csrf
