        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    {{-- Placeholder untuk client-side flash (dipakai JS tanpa reload) --}}
...
@push('styles')
    <style>
        ...
        #dt-ace tfoot .ace-summary-row:first-child td { border-top: 2px solid #333 !important; }
        #dt-ace tfoot .ace-summary-row td {
            background: #fff; font-size: .95rem; line-height: 1.25; padding: .5rem .75rem;
            height: auto !important; text-align: center; vertical-align: middle; border-top: 1px solid #dee2e6 !important;
        }
