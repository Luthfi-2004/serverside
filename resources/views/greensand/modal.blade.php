    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <form id="gsForm" class="modal-content" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <!-- meta (tetap pakai card kalau mau, tapi permintaanmu “tanpa card” berlaku mulai dari tab ke bawah) -->
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row">
                ...
                <ul class="nav nav-tabs mb-3" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-additive" role="tab">
                            <i class="ri-pie-chart-2-line mr-1"></i> Additive
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-bc" role="tab">
                            <i class="ri-alert-line mr-1"></i> BC Sample
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-return" role="tab">
                            <i class="ri-recycle-line mr-1"></i> Return Sand
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-moulding" role="tab">
                            <i class="ri-hammer-line mr-1"></i> Data Moulding
                        </a>
                    </li>
                </ul>
                            ...
                            @foreach ($mmFields as [$name, $label])
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" step="any" name="{{ $name }}" id="{{ $name }}"
                                        class="form-control" placeholder="Enter Sample {{ $label }}">
                                </div>
                            @endforeach
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="any" name="bc12_cb" id="bc12_cb"
                                        class="form-control" placeholder="Enter Sample BC12 CB">
                                </div>
                                <div class="mb-3">
                                    <label class="mb-1">BC 11 (AC)</label>
                                    <input type="number" step="any" name="bc11_ac" id="bc11_ac"
                                        class="form-control" placeholder="Enter Sample BC11 AC">
                                </div>
                                <div class="mb-0">
                                    <label class="mb-1">BC 16 (CB)</label>
                                    <input type="number" step="any" name="bc16_cb" id="bc16_cb"
                                        class="form-control" placeholder="Enter Sample BC16 CB">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="mb-1">BC 12 (M)</label>
                                    <input type="number" step="any" name="bc12_m" id="bc12_m"
                                        class="form-control" placeholder="Enter Sample BC12 M">
                                </div>
                                <div class="mb-3">
                                    <label class="mb-1">BC 11 (VSD)</label>
                                    <input type="number" step="any" name="bc11_vsd" id="bc11_vsd"
                                        class="form-control" placeholder="Enter Sample BC11 VSD">
                                </div>
                                <div class="mb-0">
                                    <label class="mb-1">BC 16 (M)</label>
                                    <input type="number" step="any" name="bc16_m" id="bc16_m"
                                        class="form-control" placeholder="Enter Sample BC16 M">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="tab-return" role="tabpanel">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="rs_type" id="rs_type" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <input type="number" step="any" name="bc9_moist" id="bc9_moist"
                                        class="form-control" placeholder="Enter Sample Moisture BC 9">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input type="number" step="any" name="bc10_moist" id="bc10_moist"
                                        class="form-control" placeholder="Enter Sample Moisture BC 10">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input type="number" step="any" name="bc11_moist" id="bc11_moist"
                                        class="form-control" placeholder="Enter Sample Moisture BC 11">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <input type="number" step="any" name="bc9_temp" id="bc9_temp"
                                        class="form-control" placeholder="Enter Sample Temp BC 9">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input type="number" step="any" name="bc10_temp" id="bc10_temp"
                                        class="form-control" placeholder="Enter Sample Temp BC 10">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input type="number" step="any" name="bc11_temp" id="bc11_temp"
                                        class="form-control" placeholder="Enter Sample Temp BC 11">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="tab-moulding" role="tabpanel">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="1" min="0" name="add_water_mm" id="add_water_mm" class="form-control"
                                    placeholder="Enter Sample Add Water MM 1">
                                <div id="add_water_mm_error" class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="mb-1">Add Water MM 2</label>
                                <input type="number" step="1" min="0" name="add_water_mm_2" id="add_water_mm_2" class="form-control"
                                    placeholder="Enter Sample Add Water MM 2">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="any" name="rcs_pick_up" id="rcs_pick_up"
                                    class="form-control" placeholder="Enter Sample RCS Pick Up">
                                <div id="rcs_pick_up_error" class="invalid-feedback"></div>
                            </div>

                            <div class="col-md-3 mb-3">
                                <label class="mb-1">Total Flask</label>
                                <input type="number" step="any" name="total_flask" id="total_flask"
                                    class="form-control" placeholder="Enter Sample Total Flask">
                                <div id="total_flask_error" class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="mb-1">RCS Avg</label>
                                <input type="number" step="any" name="rcs_avg" id="rcs_avg"
                                    class="form-control" placeholder="Enter Sample RCS Avg">
                                <div id="rcs_avg_error" class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="mb-1">Add Bentonite MA</label>
                                <input type="number" name="add_bentonite_ma" id="add_bentonite_ma"
                                    class="form-control" placeholder="Enter Sample Add Bentonite MA">
                                <div id="add_bentonite_ma_error" class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="mb-1">Total Sand</label>
                                <input type="number" step="any" name="total_sand" id="total_sand"
                                    class="form-control" placeholder="Enter Sample Total Sand   ">
