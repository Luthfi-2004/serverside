<thead class="table-dark">
    ...
    @php
        ...
        $UNIT_MM = [
            'P'=>'g / Cm²','C'=>'Mpa','G.T'=>'g / Cm²','CB MM'=>'%','CB Lab'=>'%','M'=>'%','Bakunetsu'=>'%','AC'=>'%','TC'=>'%','Vsd'=>'%','IG'=>'%','CB weight'=>'g','TP 50 weight'=>'g','TP 50 Height'=>'-','SSI'=>'%',
        ];
        $FREQ_MM = [
            'P'=>'min 6x/shift/MM','C'=>'min 6x/shift/MM','G.T'=>'min 2x/shift/MM','CB MM'=>'Every mixing','CB Lab'=>'min 6x/shift/MM','M'=>'min 6x/shift/MM','Bakunetsu'=>'min 1x/shift/MM','AC'=>'min 2x/shift','TC'=>'min 1x/shift','Vsd'=>'min 2x/shift','IG'=>'min 2x/shift/MM','CB weight'=>'min 2x/shift/MM','TP 50 weight'=>'min 2x/shift/MM','TP 50 Height'=>'min 1x/shift/MM','SSI'=>'min 2x/shift/MM',
        ];
        $UNIT_BC = [
            'BC12 CB'=>'%','BC12 M'=>'%','BC11 AC'=>'%','BC11 VSD'=>'%','BC16 CB'=>'%','BC16 M'=>'%',
        ];
        $FREQ_BC = [
            'BC12 CB'=>'min 2x/shift','BC12 M'=>'min 2x/shift','BC11 AC'=>'min 1x/shift','BC11 VSD'=>'min 1x/shift','BC16 CB'=>'min 2x/shift','BC16 M'=>'min 2x/shift',
        ];
    @endphp
